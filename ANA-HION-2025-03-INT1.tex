...
\input{ANA-HION-2025-03-INT1-metadata}
...
%\input{text/ATLAS}
\input{text/Datasets}
\input{text/Event_selection}
\input{text/Track_selection}
\input{text/Corrections}
\input{text/Glauber}
\input{text/Systematics}
\input{text/Results}
...
\PrintAtlasContribute{0.30}
\begin{itemize}
\item Patrik Novotny: Data analysis, emphasis on \OO. Text editing. 
\item Pavel Pavzderin: Data analysis, emphasis on \pp. Text editing. 
\item Alexander Milov: Analysis supervision and text editing.
\end{itemize}
