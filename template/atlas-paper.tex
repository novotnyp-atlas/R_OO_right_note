...
%  hepdatatext           Switch on text about HEPData after the acknowledgements.
%  athenadatatext        Switch on text about Athena being open source after the acknowledgements.
...
% The acknowledgements for a particular paper can be inspected on the web page:
% \url{https://twiki.cern.ch/twiki/bin/view/AtlasProtected/AcknowledgementInfo}.
...
%-------------------------------------------------------------------------------
% ATLAS papers usually should include text on HEPData and Athena.
% Options to control what is printed should be passed to the document class.
% Use option hepdatatext to turn on/off HEPData text.
% Use option hepdataexist to indicate HEPData exists (or will exist).
% Use option athenatext to turn on/off text about Athena being open source.
% Use the macro \HEPDataRecord in the metadata file to set the URL.
% \printatlasdatapolicy
