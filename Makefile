...
#------------------------------------------------------------------------------
# By default makes ANA-HION-2025-03-INT1.pdf using target run_pdflatex.
# Replace ANA-HION-2025-03-INT1 with your main filename or add another target set.
...
BASENAME = ANA-HION-2025-03-INT1
...
# Default target - make ANA-HION-2025-03-INT1.pdf with latexmk.
default: run_latexmk
...
help:
	...
	@echo "make newpaper [BASENAME=ANA-HION-2025-03-INT1]"
	@echo "To create a new ATLAS note draft give the command:"
	@echo "make newnote [BASENAME=ANA-HION-2025-03-INT1]"
	@echo "To create a long document (book) like a TDR:"
	@echo "make newbook [BASENAME=ANA-HION-2025-03-INT1]"
	@echo ""
	...
	@echo "make newpapertexmf|newnotetexmf|newbooktemf [BASENAME=ANA-HION-2025-03-INT1]"
	@echo ""
	@echo "If you need a standalone draft cover give the commands:"
	@echo "make draftcover [BASENAME=ANA-HION-2025-03-INT1]"
	@echo "pdflatex ANA-HION-2025-03-INT1-draft-cover"
	@echo ""
	@echo "If you need a standalone preprint cover give the commands:"
	@echo "make preprintcover [BASENAME=ANA-HION-2025-03-INT1]"
	@echo "pdflatex ANA-HION-2025-03-INT1-preprint-cover"
	@echo ""
	@echo "If you need a document for HepData material give the commands:"
	@echo "make newdata [BASENAME=ANA-HION-2025-03-INT1]"
	@echo "pdflatex ANA-HION-2025-03-INT1-hepdata-main"
	@echo ""
